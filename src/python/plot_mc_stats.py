...
def PlotFigure(mc_step1, log_lik1, div_3, div0_3, new_data_lists, start):
    ...
    ax2.plot(
        mc_step1[start:],
        div_3[start:],
        label="MH decrease accept: " + str(last),
        color="C1",
    )
    ax2.plot(
        mc_step1[start:],
        div0_3[start:],
        label="MH APM decrease accept: " + str(last),
        color="C4",
    )

    ax2.plot(
        mc_step1[start:],
        new_data_lists[0][start:],
        label="Accept proportion: " + str(last),
        color="C2",
    )
    ax2.plot(
        mc_step1[start:],
        new_data_lists[1][start:],
        label="MH APM accept proportion: " + str(last),
        color="C3",
    )
